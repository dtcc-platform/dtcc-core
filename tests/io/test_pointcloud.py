...
class TestPointcloud(unittest.TestCase):
    ...
    def test_load_pointcloud_list(self):
        pc = io.load_pointcloud([self.building_las_file, self.building_las_file])
        self.assertEqual(len(pc.points), 8148 * 2)
        self.assertEqual(len(pc.classification), 8148 * 2)
