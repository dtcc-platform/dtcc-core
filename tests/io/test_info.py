import unittest
from dtcc_core.io import info
from pathlib import Path

data_path = Path(__file__).parent / ".." / "data"


las_file = data_path /"MinimalCase/pointcloud.las"
buildings = data_path /"MinimalCase/PropertyMap.shp"
roads = data_path /"road_network/test_road.shp"
dem_raster = data_path /"test_dem.tif"
img_raster = data_path /"14040.png"
mesh = data_path /"cube.stl"


class TestPointcloudInfo(unittest.TestCase):
    def test_point_count(self):
        pc_info = info.info_pointcloud(las_file)
        self.assertEqual(pc_info["count"], 8148)

    def test_bounds(self):
        pc_ifno = info.info_pointcloud(las_file)
...
class TestVectorInfo(unittest.TestCase):
    def test_feature_count(self):
        feature_info = info.info_vector(buildings)
    ...
    def test_geometry_type_line(self):
        feature_info = info.info_vector(roads)
