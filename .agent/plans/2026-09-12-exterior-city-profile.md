...
- Current authority: `docs/design/exterior-city-profile.md`; schema `dtcc_core/schemas/model/0.9.0/schema.yaml`; DEM contract `docs/design/terrain-dem.md`. Wire remains v6; no new production dependency or native feature hierarchy.
