...
# Demo: Parallel tiled mesh building for large cities
...
def main():
    print("=" * 80)
    print("DEMO: PARALLEL TILED MESH BUILDING")
    print("=" * 80)
    print()
    ...
    # Build mesh WITH PARALLEL TILING
    print("Step 6: Building surface mesh (PARALLEL TILING - auto n_workers)...")
    print("-" * 80)
    num_cpus = os.cpu_count() or 4
    print("Parameters:")
    print(f"  Tile size: 1000.0m x 1000.0m")
    print(f"  Tile overlap: 50.0m")
    print(f"  Workers: {num_cpus} (PARALLEL PROCESSING)")
    print(f"  LOD: LOD0")
    ...
    print("-" * 80)
    output_path = "demo_mesh_parallel_tiling.vtu"
    time_start = time.perf_counter()
    ...
    print()
    print("Note: Run demo_tiling_serial.py to compare with serial processing")
    print("=" * 80)
