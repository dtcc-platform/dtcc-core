...
Companion to demos/smoke_table_cases.py, sharing the same physical-model
bounds. The synthetic smoke cases carry no real geometry, so they cannot
show whether the projection lands on the printed buildings. This case
exports the real building footprints as EPSG:3006 GeoJSON: projected on
the table, the outlines should sit exactly on the physical model.
