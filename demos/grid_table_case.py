...
Companion to demos/footprints_table_case.py, sharing the same
physical-model bounds. The printed model is 40 cm x 40 cm (1:1250), so
40 grid cells over the 500 m bounds put the lines exactly 1 cm apart
on the model: projected on the table, every line of the 41 x 41 line
grid should sit on the corresponding centimeter mark.
