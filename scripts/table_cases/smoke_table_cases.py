...
Operational table-case script for the legacy smoke table pack. The canonical
table catalog generator will migrate this information into declarative table
model specs; until then this script preserves the existing generation path.
