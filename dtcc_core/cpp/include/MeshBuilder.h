...
public:
                                 ...
                                 bool sort_triangles = false)
  {
    ...
    // build boundary
    Mesh ground_mesh =
        build_ground_mesh(subdomains, subdomain_triangle_size,  bbox.P.x, bbox.P.y, bbox.Q.x, bbox.Q.y,
                                ...
                                bool sort_triangles = true)
  {
    ...
    // build 2D mesh
    Mesh mesh;
    Triangulate::call_triangle(mesh, boundary, triangle_sub_domains, subdomain_triangle_size, max_mesh_size,
